...
from airflow.utils.task_group import TaskGroup  # Importa a classe TaskGroup para agrupar tarefas.
...
with DAG(
    ...
    task6 >> tsk_group  # Define que as tasks 7, 8 e 9 serão executadas em paralelo após a execução da task 6.
